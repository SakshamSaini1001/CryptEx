...
import {FETCH_COIN_LIST_REQUEST, FETCH_COIN_BY_ID_REQUEST, FETCH_COIN_DETAILS_REQUEST, FETCH_TOP50_COINS_REQUEST, SEARCH_COIN_REQUEST, FETCH_MARKET_CHART_REQUEST, FETCH_COIN_LIST_SUCCESS, FETCH_TOP50_COINS_SUCCESS, FETCH_MARKET_CHART_SUCCESS, FETCH_COIN_BY_ID_SUCCESS, SEARCH_COIN_SUCCESS, FETCH_MARKET_CHART_FAILURE, FETCH_COIN_LIST_FAILURE, FETCH_COIN_BY_ID_FAILURE, SEARCH_COIN_FAILURE, FETCH_COIN_DETAILS_FAILURE, FETCH_TOP50_COINS_FAILURE, FETCH_COIN_DETAILS_SUCCESS } from "./ActionType"
...
const coinReducer = (state=initialState,action) => {
    switch(action.type){
        ...
        case FETCH_COIN_LIST_SUCCESS:
           return {...state,getCoinList:action.payload, loading:false ,error:null}

        case FETCH_TOP50_COINS_SUCCESS:
            return {...state,top50:action.payload,loading:false,error:null}

        case FETCH_MARKET_CHART_SUCCESS:
            return {...state,marketChart: {data: action.payload.prices},loading:false}
