...
export const getWalletransactions =({jwt}) => async(dispatch) => {
...
export const paymentHandler =({jwt,amount}) => async(dispatch) => {
    dispatch({type: types.DEPOSIT_MONEY_REQUEST
    });
    ...
    console.log("Payment API response:", response); // Add this line to check the API response
